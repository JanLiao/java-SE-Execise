...
public class WhoisGUI extends JFrame{
		...
		chosenServer.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event){
				try{
					...
					JOptionPane.showMessageDialog(p, e.getMessage(), "Alert", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		return p;
	...
	public static void main(String[] args){
		try{
			...
			JOptionPane.showMessageDialog(null, "Could not locate default host " + Whois.DEFAULT_HOST, "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
