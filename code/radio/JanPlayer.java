...
public class JanPlayer extends JFrame implements ActionListener,ItemListener{
...
public void actionPerformed(ActionEvent e1){
	...
	int value;
	    ...
	    value=100*(timerstart+1)/timetotal;
...
public static void main(String[] args){
	SwingUtilities.invokeLater(new Runnable(){
		public void run(){
			JanPlayer jplayer=new JanPlayer();
